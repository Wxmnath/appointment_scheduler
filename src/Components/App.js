...
export default class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      validEmail: true,
      validPhone: true,
      smallScreen: window.innerWidth < 740,
    ...
    //   this.handleSetAppointmentMeridiem.bind(this);
    ...
    //   this.renderAppointmentConfirmation.bind(this);
  ...
  handleSubmit() {
    //sends the submitted info to the backend.
    const appointment = {
  ...
  checkDisableDate(day) {
    //Stops unavailable days being shown to the user.
  ...
  renderAppointmentConfirmation() {
    //Confirm your appointment pop up
    const spanStyle = { color: "#00bcd4" };
    return (
      <section>
        <p>
  ...
  componentDidMount() {
    //lifecycle method to fetch already booked data from the backend.
    const saveResults = async () => {
      ...
      appointmentData.map((appointment) => {
        return (
          !bookedDates.includes(appointment.date) &&
      ...
      for (let bookedDay in bookedDatesObj) {
        ...
        obj.length === 8 &&
          this.setState({ fullDays: [...this.state.fullDays, bookedDay] });
      }
  ...
  render() {
    ...
    const contactFormFilled = //confirms the booking info, do we need all of this to confirm?
      data.firstName &&
      data.lastName &&
      data.phone &&
      data.email &&
          ...
          >
            ...
            >
              ...
              <Step disabled={!data.appointmentDate}>
                ...
                <StepContent>
                  <SelectField //(2) Choose AM/PM for your appointment
                  ...
                  <RadioButtonGroup //(2)Choose time for your appointment radio buttons
              ...
              <Step disabled={!Number.isInteger(this.state.appointmentSlot)}>
                ...
                <StepContent>
                  <section>
                    <TextField //Do we want to use this section to make payment?
                      style={{ display: "block" }}
                      name="first_name"
                      hintText="First Name"
